...
public class gitHubProject {
    String sshKey="ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIESVGPfn+yLfOJMjh2iv2qnzBS2H6eM8wrN6ikwn+ACy";
    int sshKeyId;
    RequestSpecification requestSpec=new RequestSpecBuilder()
            .setBaseUri("https://api.github.com/user/keys")
            .addHeader("Authorization","token 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")
